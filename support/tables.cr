module Support
        ...
        class_getter str = [
          ...
          [ "ExitDeleteMode",              "exit_delete_mode"          , "rmdc"], #  end delete mode # XXX removed "ed" tcap in favor of terminfo's "ed" (clr_eos)
          ...
          [ "SetLrMargin",                 "set_lr_margin"             , "smglr", ], # Set both left and right margins to #1, #2.  (ML is not in BSD term‐ cap). # XXX removed tcap "ML" in favor of tcap "ML" (set_left_margin)
